...
def create_recurring_transaction(title, src, dst, amount, type, interval,
                                 multiplier=1, date=date.today()):
    r = RecurringTransaction.objects.create(title=title, date=date, transaction_type=type,
