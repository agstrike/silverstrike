...
from silverstrike.models import Account, RecurringSplit, RecurringTransaction, Category
...
class RecurringSplitModelTests(TestCase):
    ...
    def test_str_method(self):
        recurrence = create_recurring_transaction('some recurrence', 
    ...
    def test_is_disabled(self):
        disabled_recurrence = create_recurring_transaction('recurrence', 
            self.foreign, self.personal, 100, RecurringTransaction.DEPOSIT, 
            RecurringTransaction.DISABLED)
        recurrence = create_recurring_transaction('recurrence', 
            self.foreign, self.personal, 100, RecurringTransaction.DEPOSIT, 
