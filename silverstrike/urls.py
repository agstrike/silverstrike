...
urlpatterns = [
    ...
    path('transactions/', transaction_views.TransactionIndex.as_view(),
         name='transactions'),
    ...
    path('recurrences/create/transfer/',
         recurrence_views.RecurrenceCreateView.as_view(), {'type': 'transfer'},
         name='recurring_transfer_new'),
    path('recurrences/create/withdraw/',
         recurrence_views.RecurrenceCreateView.as_view(), {'type': 'withdraw'},
         name='recurring_withdraw_new'),
    path('recurrences/create/deposit/',
         recurrence_views.RecurrenceCreateView.as_view(), {'type': 'deposit'},
         name='recurring_deposit_new'),
    path('recurrences/disabled/',
         recurrence_views.DisabledRecurrencesView.as_view(),
         name='disabled_recurrences'),
    path('recurrences/<int:pk>/',
         recurrence_views.RecurrenceDetailView.as_view(),
